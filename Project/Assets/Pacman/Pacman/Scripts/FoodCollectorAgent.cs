...
public class FoodCollectorAgent : Agent
{
    ...
    public void OnEaten()
    {
        if (respawn)
        {
            transform.position = new Vector3(Random.Range(-m_MyArea.range, m_MyArea.range),
                1.15f,
                Random.Range(-m_MyArea.range, m_MyArea.range)) + m_MyArea.transform.position;
        }
        else
        {
            Debug.Log("Destroyed Agent");
            Destroy(gameObject);
        }
    }
    ...
    public override void OnEpisodeBegin()
    {
        ...
        myLaser.transform.localScale = new Vector3(0f, 0f, 0f);
        transform.position = new Vector3(Random.Range(-m_MyArea.range, m_MyArea.range),
            1f, Random.Range(-m_MyArea.range, m_MyArea.range))
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        if (collision.gameObject.GetComponent(typeof(PacmanCollectorAgent)))
        {
            OnEaten();
        }
    }
