...
public class PacmanCollectorAgent : Agent
{
    FoodCollectorSettings m_FoodCollecterSettings;
    public GameObject area;
    public FoodCollectorArea m_MyArea;
    bool m_Frozen;
    bool m_Poisoned;
    bool m_Satiated;
    bool m_Shoot;
    ...
    public void MoveAgent(ActionSegment<int> act)
    {
        ...
        if (m_Shoot)
        {
            ...
            if (Physics.SphereCast(transform.position, 2f, rayDir, out hit, 25f))
            {
                ...
                {
                    hit.collider.gameObject.GetComponent<PacmanCollectorAgent>().Freeze();
                }
            }
        }
        else
    ...
    public override void OnEpisodeBegin()
    {
        ...
        transform.position = new Vector3(Random.Range(-m_MyArea.range, m_MyArea.range),
            3.5f, Random.Range(-m_MyArea.range, m_MyArea.range))
    ...
    {
        if (collision.gameObject.GetComponent(typeof(FoodCollectorAgent)))
        {
            Satiate();
            ...
            if (contribute)
            {
                m_FoodCollecterSettings.ghostScore += 1;
            }
        }
